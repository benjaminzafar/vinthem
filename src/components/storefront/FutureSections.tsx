    ...
    <section id="future" className="py-20 md:py-28 bg-[#f5f6ee]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <Link href={settings.futureProduct1Link || '/products'} className="relative aspect-[4/3] overflow-hidden rounded-none bg-gray-100 group block">
          ...
          <Link href={settings.futureProduct2Link || '/products'} className="relative aspect-[4/3] overflow-hidden rounded-none bg-gray-100 group block">
