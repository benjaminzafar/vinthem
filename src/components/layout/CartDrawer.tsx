              ...
              {items.length > 0 && (
                <div className="p-6 bg-slate-50 border-t border-slate-100 shrink-0 space-y-6">
                  ...
                  <Link
                    ...
                    onClick={handleClose}
                    className="w-full h-14 bg-slate-900 text-white flex items-center justify-center gap-3 text-[17px] font-semibold transition-all hover:bg-slate-800 rounded-full group shadow-lg shadow-slate-900/10 active:scale-[0.98]"
                  >
