  ...
  return (
    <div className="relative h-full flex items-center" ref={dropdownRef}>
      <button 
        ...
        className="flex items-center px-2 py-2 text-slate-600 hover:text-brand-ink transition-colors"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 top-[calc(100%+4px)] w-60 bg-white shadow-none rounded-none border border-slate-200 z-[100] py-2 overflow-hidden"
          >
