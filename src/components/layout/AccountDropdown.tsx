      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 0 }}
            className="absolute right-0 top-[calc(100%+1px)] mt-0 w-60 bg-white shadow-2xl shadow-slate-900/10 rounded-none border border-slate-100 z-[100] py-2 overflow-hidden"
          >
