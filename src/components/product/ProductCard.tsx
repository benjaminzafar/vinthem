  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 px-1">
        ...
        <h3 className="text-[15px] md:text-[17px] font-semibold tracking-tight text-brand-ink group-hover:text-brand-muted transition-colors line-clamp-2 mb-2">
          <Link href={href}>
            {product.title}
          </Link>
        </h3>
        <div className="mt-auto">
          <p className="text-[15px] md:text-[17px] font-medium text-brand-ink">
