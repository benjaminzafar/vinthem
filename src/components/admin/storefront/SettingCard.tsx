...
export function SettingCard({
  ...
  return (
    <motion.div 
      layout
      className="bg-white border-none shadow-none rounded-none overflow-hidden flex flex-col hover:bg-zinc-50/10 transition-all border-b border-zinc-50"
    >
      <div 
      ...
      >
        <div className="flex items-center gap-4">
          <div className="w-8 h-8 rounded-none bg-zinc-900 flex items-center justify-center transition-all-none">
            ...
            {onSave && (
              <div className="px-6 py-4 border-t border-zinc-100/50 bg-zinc-50/20 flex justify-end items-center">
                 <button
                  ...
                  disabled={isSaving}
                  className="flex items-center gap-2 px-6 py-2 bg-zinc-900 text-white rounded-none hover:bg-zinc-800 transition-all font-bold text-[12px] tracking-tight disabled:opacity-50"
                >
