            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="space-y-3">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-none-[4px] border border-slate-200 px-4 font-mono text-sm focus:border-slate-900 focus:outline-none"
                />
              </div>
              <div className="flex items-end">
                <div className="rounded-none-[4px] border border-slate-200 bg-slate-50 px-4 py-3 text-[12px] font-medium text-slate-500">
