...
export function SimpleCookieBanner({ lang = "en" }: { lang?: string }) {
  ...
  return (
    <div className="fixed inset-x-4 bottom-4 z-40 mx-auto max-w-3xl rounded-3xl border border-stone-200 bg-white px-5 py-4 shadow-[0_18px_60px_rgba(15,23,42,0.12)]">
      ...
      <p className="mt-2 text-sm leading-6 text-stone-700">
        {settings.consentBannerDescriptionText?.[lang] || "Essential cookies keep checkout and login secure. Optional analytics helps us improve the store."}
      </p>
