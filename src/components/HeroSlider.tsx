      ...
      <AnimatePresence mode="wait" initial={false}>
        ...
        >
          ...
          <div className="w-full lg:w-[45%] flex flex-col justify-center order-1 text-center lg:text-left z-10 flex-shrink-0">
            ...
            <div className="hidden lg:block">
              <Link 
                ...
                className="inline-flex items-center bg-black text-white px-10 py-4 rounded-none text-[12px] font-bold uppercase tracking-[0.2em] hover:bg-gray-800 transition-all duration-300"
              >
          ...
          <div className="w-full lg:w-[55%] order-2 z-0 flex-shrink-0 flex items-center justify-center mt-4 lg:mt-0">
            <div className="relative w-full max-h-[50vh] lg:max-h-none aspect-[16/10] sm:aspect-[16/9] lg:aspect-[4/3] xl:aspect-[16/10] overflow-hidden rounded-none shadow-none bg-zinc-50">
          ...
          <div className="w-full flex justify-center order-3 mt-8 lg:hidden z-10 flex-shrink-0 pb-10">
            <Link 
              href={localizeHref(lang, `/products?category=${encodeURIComponent(category.slug)}`)}
              className="flex items-center justify-center bg-black text-white px-8 py-4 rounded-none text-[12px] font-bold uppercase tracking-[0.2em] w-full"
            >
              {settings.shopNowText?.[lang] || 'Explore'} <ArrowRight className="ml-3 w-4 h-4" />
            </Link>
          </div>
