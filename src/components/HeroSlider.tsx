      ...
      <AnimatePresence mode="wait" initial={false}>
        ...
        >
          ...
          <div className="w-full lg:w-[45%] flex flex-col justify-center order-1 text-center lg:text-left z-10 flex-shrink-0">
            ...
            />
            <h2 className="text-3xl sm:text-4xl lg:text-6xl xl:text-7xl font-sans font-bold tracking-tight text-black leading-[1.1] mb-2 lg:mb-6 uppercase break-words">
              {category.translations?.[lang]?.name || category.name}
            </h2>
            <p className="text-gray-600 text-[14px] sm:text-base lg:text-xl font-medium leading-relaxed mb-4 lg:mb-8 max-w-md mx-auto lg:mx-0">
          ...
          <div className="w-full lg:w-[55%] order-2 z-0 flex-shrink-0 flex items-center justify-center mt-4 lg:mt-0">
            <div className="relative w-full max-h-[50vh] lg:max-h-none aspect-[16/10] sm:aspect-[16/9] lg:aspect-[4/3] xl:aspect-[16/10] overflow-hidden rounded-2xl shadow-sm">
              {category.imageUrl && (
                <Image 
                  src={imageToShow || ''} 
