...
export const defaultSettings: StorefrontSettings = {
  ...
  signUpPrivacyConsentText: { en: 'I have read the', sv: 'Jag har läst', fi: 'Olen lukenut', da: 'Jeg har læst' },
