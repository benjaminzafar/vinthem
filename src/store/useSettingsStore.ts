...
export const defaultSettings: StorefrontSettings = {
  seoTitle: { en: 'Vinthem - Premium Goods', sv: 'Vinthem - Premiumvaror', fi: 'Vinthem - Premium-tuotteet', da: 'Vinthem - Premium Varer' },
  seoDescription: { en: 'Discover premium quality goods inspired by your vision.', sv: 'Upptäck premiumvaror inspirerade av din vision.', fi: 'Löydä visiosi inspiroimia premium-tuotteita.', da: 'Opdag premium varer inspireret af din vision.' },
  ...
  footerDescription: { en: 'Premium quality goods designed for everyday life, built to last a lifetime.', sv: 'Varor av högsta kvalitet designade för vardagen, byggda för att hålla en livstid.', fi: 'Korkealaatuisia tuotteita suunniteltu jokapäiväiseen elämään, rakennettu kestämään eliniän.', da: 'Varer af højeste kvalitet designet til hverdagen, bygget til at holde hele livet.' },
